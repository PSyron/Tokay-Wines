...
public class SimpleLocation {
    ...
    /**
     * The default interval to receive new location updates after (in
     * milliseconds)
     */
    ...
    /**
     * The factor for conversion from longitude to kilometers at zero degree in
     * latitude
     */
    ...
    /**
     * The last location that was internally cached when creating new instances
     * in the same process
     */
    ...
    /**
     * The internal after which new location updates are requested (in
     * milliseconds) where longer intervals save battery
     */
    private final long mInterval;
    /**
     * The blur radius (in meters) that will be used to blur the location for
     * privacy reasons
     */
    private int mBlurRadius;
    /**
     * The LocationListener instance used internally to listen for location
     * updates
     */
     ...
     * 
     * @param context
     *            the Context reference to get the system service from
     */
     ...
     *            the Context reference to get the system service from
     * @param requireFine
     *            whether to require fine location or use coarse location
     */
     ...
     *            whether to require fine location or use coarse location
     * @param passive
     *            whether to use passive mode (to save battery) or active mode
     */
     ...
     *            whether to use passive mode (to save battery) or active mode
     * @param interval
     *            the interval to request new location updates after (in
     *            milliseconds) where longer intervals save battery
     */
    public SimpleLocation(final Context context, final boolean requireFine, final boolean passive,
            final long interval) {
    ...
    /**
     * Starts updating the location and requesting new updates after the defined
     * interval
     */
    ...
    /**
     * Stops the location updates when they aren't needed anymore so that
    ...
    /**
     * Blurs the specified location with the defined blur radius or returns an
     * unchanged location if no blur radius is set
     * 
     * @param originalLocation
     *            the original location received from the device
    ...
    private Location blurWithRadius(final Location originalLocation) {
        if (mBlurRadius <= 0) {
            ...
            newLocation.setLongitude(newLocation.getLongitude()
                    + meterToLongitude(blurMeterLong, newLocation.getLatitude()));
    ...
    /**
     * Creates a new LocationListener instance used internally to listen for
     * location updates
     * 
    ...
    /**
     * Returns the name of the location provider that matches the specified
     * settings
     * 
    ...
    /**
     * Returns the name of the location provider that matches the specified
     * settings and depends on the given granularity
     * 
     * @param whether
     *            to require fine location or use coarse location
     * @return the provider's name
     */
    ...
    /**
     * Converts a difference in latitude to a difference in kilometers (rough
     * estimation)
     * 
     * @param latitude
    ...
    /**
     * Converts a difference in kilometers to a difference in latitude (rough
     * estimation)
     * 
     * @param kilometer
     *            the kilometers (difference)
    ...
    /**
     * Converts a difference in latitude to a difference in meters (rough
     * estimation)
     * 
     * @param latitude
     *            the latitude (difference)
    ...
    /**
     * Converts a difference in meters to a difference in latitude (rough
     * estimation)
     * 
     * @param meter
     *            the meters (difference)
     * @return the latitude (difference)
     */
    ...
    /**
     * Converts a difference in longitude to a difference in kilometers (rough
     * estimation)
     * 
     * @param longitude
     *            the longitude (difference)
     * @param latitude
     *            the latitude (absolute)
     * @return the kilometers (difference)
     */
    public static double longitudeToKilometer(double longitude, double latitude) {
        return longitude * LONGITUDE_TO_KILOMETER_AT_ZERO_LATITUDE
                * Math.cos(Math.toRadians(latitude));
    }

    /**
     * Converts a difference in kilometers to a difference in longitude (rough
     * estimation)
     * 
     * @param kilometer
     *            the kilometers (difference)
    ...
    /**
     * Converts a difference in longitude to a difference in meters (rough
     * estimation)
     * 
     * @param longitude
     *            the longitude (difference)
    ...
    /**
     * Converts a difference in meters to a difference in longitude (rough
     * estimation)
     * 
     * @param meter
     *            the meters (difference)
    ...
    /**
     * Calculates the difference from the start position to the end position (in
     * meters)
     * 
     * @param start
     *            the start position
     ...
     * 
     * @param startLatitude
     *            the latitude of the start position
     * @param startLongitude
     *            the longitude of the start position
     * @param endLatitude
     *            the latitude of the end position
     * @param endLongitude
     *            the longitude of the end position
     * @return the distance in meters
     */
